    ...
    for(i=0;i<global.N_objects;i++)
        ...
        if (inside_zoomed_box(x,y))
            ...
            if (color==2) glColor3f(1.0, 0.0, 0.0);
               ...
               if (color==2) glColor3f(1.0,1.0,1.0);//white, no particle (not filled in percolation)
               else if (color==3) glColor3f(31/255.0,120/255.0,180/255.0);
               else if (color==4) glColor3f(178/255.0,223/255.0,138/255.0);
               else if (color==5) glColor3f(51/255.0,160/255.0,44/255.0);
               else if (color==6) glColor3f(251/255.0,154/255.0,153/255.0);
               else if (color==7) glColor3f(227/255.0,26/255.0,28/255.0);
               else if (color==8) glColor3f(253/255.0,191/255.0,111/255.0);
               else if (color==9) glColor3f(255/255.0,127/255.0,0/255.0);
               else if (color==10) glColor3f(202/255.0,178/255.0,214/255.0);
